...
namespace LabRab6
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (int i in Enum.GetValues(typeof(Soliders)))
                Console.WriteLine(i);
    ...
    static class Controller
    {
        public static void GetWarriorByYear(Army a, string year)
        {
            foreach (IntelligentCreature i in a.army)
            {
                if (year == i.year)
                {
                    Console.WriteLine(i.name + " - Соладат, с датой рождения 1955г.");
                }
            }
        }
        public static void PrintWarriors(Army a, string power)
        {
            foreach (IntelligentCreature i in a.army)
            {
                if (power == i.power)
                {
                    Console.WriteLine(i.name + " - Солдат с силой 3000");
                }
            }
        }
        public static void PrintCount(Army a)
        {
            ...
            Console.WriteLine(i + " - Число солдат");
        }
    }
    public class Army
    {
